...
'ALLSTATS_user_lock'=>'Взятых в работу',
'ALLSTATS_user_ok'=>'Выполненных',
'ALLSTATS_user_out_all'=>'Созданных (всего)',
'ALLSTATS_user_out_all_not'=>'Созданных (не выполненных)',
...
'FILES_del'=>'Удалить',
'FILES_down'=>'Скачать',
'FILES__ticket'=>'Файлы в заявках',
'FILES__comment'=>'Файлы в комментариях',
...
'CONF_ticket_update'=>'Для подсчета времени работы с заявкой, добавьте в cron-планировщик строку:',
...
'CONF_jabber_name'=>'Настройки Jabber',
'CONF_jabber_status'=>'Уведомления jabber',
'CONF_jabber_server'=>'Сервер jabber',
'CONF_jabber_port'=>'Порт',
'CONF_jabber_login'=>'Логин',
'CONF_jabber_pass'=>'Пароль',
'CONF_shudown_permit'=>'Разрешение на выключение сервера',
'CONF_pass_server'=>'Пароль www-data',
 ...
 'DASHBOARD_ticket_lock'=>'в обработке мной',
 ...
 'DASHBOARD_ticket_out_desc_unit'=>'Заявки, созданные Вами или сотрудниками отдела(ов) и остались не выполненными',
 'DASHBOARD_last_news'=>'Последние изменения',
 'DASHBOARD_last_help'=>'Последнее из Центра Знаний',
 'DASHBOARD_deadline' => 'крайний срок: ',
 ...
 'DASHBOARD_last_notes'=>'Последние записи из Блокнота',
 'DASHBOARD_author'=>'Автор',
 'DASHBOARD_notes_dt'=>'Дата создания',
 ...
 'NEW_from'=>'От кого',
 'NEW_from_desc'=>'ФИО или<br>логин<br>пользователя,<br>который<br>обратился за<br>помощью',
 'NEW_fio'=>'ФИО или логин пользователя',
 'NEW_fio_desc'=>'Пожалуйста, заполните это поле',
 'NEW_to'=>'Кому',
 'NEW_to_desc'=>'Исполнитель заявки:<br> 1. Весь отдел.<br>2. Опционально конкретный<br>сотрудник отдела или несколько сотрудников отедела.',
 'NEW_to_unit'=>'Отдел',
 'NEW_to_unit_desc'=>'Укажите отдел назначения и опционально пользователя',
 'NEW_to_user'=>'Исполнитель',
 'NEW_prio'=>'Приоритет',
 'NEW_prio_low'=>'Низкий',
 'NEW_prio_norm'=>'Средний',
 'NEW_prio_high'=>'Высокий',
 'NEW_prio_high_desc'=>'Будет<br>задействовано<br>SMS-<br>информирование',
 'NEW_subj'=>'Тема',
 ...
 'NEW_povtor' => 'Повтор',
 'NEW_povtor_text' => 'Отметьте, если нужно сохранить введенную тему и текст сообщения.',
 'NEW_deadline' => 'Крайний срок',
 'NEW_ok_familiar' => 'Подтверждение',
 'NEW_ok_familiar_text' => 'Отметьте, если заявку можно будет выполнить только после того, как все с ней ознакомяться!',
 'NEW_deadline_info' => 'При необходимости можно указать крайний срок заявки. <br>PS (Дата и время не должны быть меньше текущих!)',

 'LIST_title'=>'Список заявок',
 'LIST_ok_t'=>'выполненные заявки',
 'LIST_lock_t_i'=>'заявки, с которыми Вы работаете',
 'LIST_lock_t'=>'заявки, с которыми другие работают',
 'LIST_lock_n'=>'номер заявки',
 'LIST_find_er'=>'Поле поиска не может быть пустым!',
 'LIST_find_ph'=>'Введите # или тему заявки, или текст заявки, или текст комментария, или Исполнителя заявки',
...
't_LIST_subj'=>'Тема',
't_LIST_worker'=>'Инициатор',
't_LIST_create'=>'Создана',
't_LIST_ago'=>'Прошло',
't_LIST_init'=>'Автор',
...
'stats_last_time_never'=>'Никогда',
't_list_a_nook'=>'отметить, как не выполнено',
't_list_a_unlock'=>'снять с обработки',
't_list_a_lock'=>'взять в работу',
't_list_a_ok'=>'выполнить',
't_list_a_all'=>'Всем',
't_list_a_other'=>' и другие',
...
't_list_files_a_arch'=>'заявка в архиве',
't_list_files_a_work'=>'заявка в работе',
...
'TICKET_name'=>'Заявка',
'TICKET_print'=>'распечатать заявку',
...
'PROFILE_msg_error'=>'Логин или e-mail имеют не корректный формат.',
'PROFILE_msg_email_duplicate' => 'Такой e-mail уже есть в системе.',
'PROFILE_msg_email_validate' => 'E-mail имеeт не корректный формат.',
'PROFILE_msg_login_validate' => 'Логин имеeт не корректный формат.',
...
'TICKET_msg_familiar'=>'C заявкой ознакомились',
'empty'=>'пусто',
...
'TICKET_delete' => '<i class="fa fa-trash-o"></i> удалить',
...
'TICKET_t_worker'=>'Инициатор',
'TICKET_t_last_up'=>'Последнее обновление',
'TICKET_t_status'=>'Статус',
'TICKET_t_prio'=>'Приоритет',
'TICKET_t_subj'=>'Тема',
'TICKET_t_refer'=>'Переадресация',
'TICKET_t_refer_ok'=>'Переадресовать',
'TICKET_t_refer_to'=>'Переадресация на',
'TICKET_t_opt'=>'опционально',
'TICKET_t_in_arch'=>'Заявка находится в архиве.',
'TICKET_t_ok'=>'<strong>Внимание</strong><br><i class="fa fa-check-circle"></i> Заявка успешно выполнена пользователем',
'TICKET_t_ok_1'=>'Через некоторое время заявка перейдет в архив.',
'TICKET_t_lock'=>'<strong>Внимание</strong><br><i class="fa fa-info-circle"></i> В настоящее время с заявкой работает пользователь',
'TICKET_t_lock_1'=>'Поэтому Вы не можете работать с заявкой.',
'TICKET_t_lock_2'=>'Нажмите кнопку с заявкой ознакомился.',
'TICKET_t_lock_3'=>'<br><b>Заявку нельзя выполнить пока с ней все не ознакомяться.</b>',
'TICKET_t_lock_4'=>'<br><b>Вы успешно ознакомились с заявкой!</b>',
'TICKET_t_lock_i'=>'<strong>Внимание</strong><br><i class="fa fa-info-circle"></i> В настоящее время Вы работаете с заявкой. Для того, чтобы другие могли работать, разблокируйте ее.',
'TICKET_t_comment'=>'Комментарии',
'TICKET_t_history'=>'История изменений',
'TICKET_t_your_comment'=>'Ваш комментарий',
'TICKET_t_det_ticket'=>'Укажите комментарий',
'TICKET_t_comm_ph'=>'Комментарий к заявке',
'TICKET_t_send'=>'Отправить',
'TICKET_t_date'=>'Дата',
'TICKET_t_init'=>'Автор',
'TICKET_t_action'=>'Действие',
'TICKET_t_familiar'=>'С заявкой ознакомился',
'TICKET_t_familiars'=>'С заявкой ознакомились',
'TICKET_t_desc'=>'Описание',
'TICKET_t_a_familiar'=>'c заявкой ознакомился',
...
'TICKET_t_a_to_user'=>'Исполнитель: ',
'TICKET_t_a_other'=>' и другие',
...
'TICKET_not_deadline'=>'не установлено',
'TICKET_deadline'=>'Крайний срок заявки',
'TICKET_deadline_dt'=>'Срок',
'TICKET_deadline_ok'=>'выполнена в срок',
'TICKET_reaction'=>'Время реакции на заявку',
'TICKET_not_lock'=>'еще не взята',
'TICKET_ok_dt'=>'Время выполнения заявки',
...
'NAVBAR_help'=>'Помощь',
'NAVBAR_logout'=>'Выйти',
'NAVBAR_users_online'=>'Статус пользователей',
'NAVBAR_users_online2'=>'Пользователей онлайн',
'NAVBAR_shut'=>'Выключение сервера',
...
'TICKET_ACTION_lock'=>'взята в работу пользователем',
'TICKET_ACTION_unlock'=>'снята с обработки пользователем',
'TICKET_ACTION_create'=>'создана пользователем',
'TICKET_ACTION_edit'=>'изменена пользователем',
'TICKET_ACTION_comment'=>'прокомментирована пользователем',
'TICKET_ACTION_arch'=>'заявка перенесена в архив',
'TICKET_ACTION_familiar'=>'с заявкой ознакомился пользователь',
...
'NOTES_cr'=>'Добавление новой или выберите...',
...
'P_noty'=>'Настройка уведомлений',
'P_create'=>'новая заявка',
'P_refer'=>'заявка переадресована',
'P_comment'=>'заявка прокомментирована',
'P_lock'=>'заявка взята в работу',
'P_unlock'=>'заявка снята с обработки',
'P_ok'=>'заявка выполнена',
'P_no_ok'=>'заявка не выполнена',
'P_msg'=>'в заявке изменен текст',
'P_subj'=>'в заявке изменена тема',
'P_familiar'=>'с заявкой ознакомились',
'P_noty_show'=>'Уведомления на сайте',
'P_noty_show_p'=>'Выберите уведомления',
'P_top'=>'Сверху страницы',
'P_topLeft'=>'Сверху, слева страницы',
'P_topRight'=>'Сверху, справа  страницы',
'P_topCenter'=>'Сверху, поцентру страницы',
'P_center'=>'Поцентру страницы',
'P_centerLeft'=>'Поцентру, слева страницы',
'P_centerRight'=>'Поцентру, справа страницы',
'P_bottom'=>'Снизу страницы',
'P_bottomLeft'=>'Снизу, слева страницы',
'P_bottomRight'=>'Снизу, справа страницы',
'P_bottomCenter'=>'Снизу, поцентру страницы',
'P_noty_show_site'=>'Расположение уведомление на сайте',
'P_jabber_show'=>'Какие уведомления показывать в jabber',
...
'JS_ticket_delete' => '<center><font size="14">Вы дейстивтельно хотите удалить заявку?</font></center>',
'JS_ticket_delete_title' => 'Удаление заявки',
'JS_ticket_delete_cancel' => '<i class="fa fa-remove"></i> Отменить',
'JS_d' => 'дн',
'JS_h' => 'час',
'JS_m' => 'мин',
'JS_s' => 'сек',
'JS_nextMonth' => 'Следующий месяц',
'JS_prevMonth' => 'Предыдущий месяц',
'JS_selectMonth' => 'Выбрать месяц',
'JS_selectYear' => 'Выбрать год',
'JS_nextYear' => 'Следующий год',
'JS_prevYear' => 'Предыдущий год',
'JS_selectDecade' => 'Выбрать десятилетие',
'JS_nextDecade' => 'Следующий десятелете',
'JS_prevDecade' => 'Предыдущий десятелете',
'JS_nextCentury' => 'Следующий век',
'JS_prevCentury' => 'Предыдущий век',
...
'USERS_pass'=>'Пароль',
'USERS_mail'=>'E-mail',
'USERS_jabber'=>'Логин Jabber',
'USERS_units'=>'Отделы',
'USERS_unit'=>'Отдел',
'USERS_admin'=>'Администратор',
'USERS_admin_info'=>'Будет ли пользователь администратором системы',
...
'Add_users'=>'Добавить в пользователи',
'Add_users_info'=>'Автоматически добавить в пользователи (ФИО, логин, E-mail)',
...
'STATS_help1'=>'<li> новые - заявки , которые адресованы Вам или Вашему отделу и Вы можете их выполнить. </li > <li> Взяты в работу - заявки, над которыми Вы работаете. </li > <li> Выполненные - заявки, которые Вы уже выполнили (через некоторое время перейдут в архив и исчезнут по графику) </li >',
'STATS_help2'=>'<li> Не выполненные - заявки, которые вы создали, но их еще никто не выполнил. </li > <li> Взяты в работу - заявки, над которыми кто-то работает. </li > <li> Выполненные - заявки, которые Вы создали и их выполнили </li >',
...
'msg_creted_new_user' => 'Будет создан новый пользователь.',
...
'MAIL_to' => 'Кому',
'MAIL_prio' => 'Приоритет',
'MAIL_worker' => 'Инициатор',
'MAIL_msg' => 'Сообщение',
'MAIL_subj' => 'Тема',
'MAIL_text' => 'Текст',
't_LIST_worker_to' => 'пользователю',
't_LIST_person' => 'персонально',
'JABBER_users' => 'Вам поступила Новая Заявка под номером #',
'JABBER_all' => 'В ваш отдел поступила Новая Заявка под номером #',
'JABBER_coord' => 'Пользователю',
'JABBER_coord1' => 'поступила Новая Заявка под номером #',
'JABBER_href' => '! Ссылка на заявку >>>',
'Perf_jabber_sent'=>'Тестовое сообщение jabber отправленно.',
'Perf_jabber_sent_error'=>'Не все поля заполнены!',
'Perf_jabber_sent_shut'=>'Отправка уведомлений через jabber выключена!',
'Perf_jabber_msg'=>'Тестовое сообщение :)',
...
'HELP_edit_prof' => 'Редактирование профиля',
'HELP_new_text' => '<p>Для создания заявки, Вам необходимо заполнить обязательные поля.
                                ...
                                <ol>
                                    ...
                                    <li><strong>Крайний срок</strong> - при желании можно указать крайний срок выполнения заявки.</li>
                                    <li><strong>Повтор</strong> - если нужно создать несколько заявок разным исполнителям. При активации этого пункта, сохраняется введеная тема и текст сообщения после нажатия кнопки создать заявку. После этого создаете следующую заявку и т.д..</li>
                                    <li><strong>Тема</strong> - указывается кратко тема заявки.</li>
                                    <li><strong>Сообщение</strong> - указывается подробно суть заявки.</li>
                                    <li><strong>Файл</strong> - при необходимости прикрепите файлы.</li>
                                </ol>',
'HELP_review_text' => '<p>Вам доступны три "каталога": "Входящие", "Исходящие", "Архив". Подробно о них ниже.
				...
				<centre>
				<img src="img/help3.png" class="img-responsive img-thumbnail">
				</center>
                                <p>
                                ...
                                <ul>
                                    ...
                                    <li><strong>Взять в работу ее</strong> - для того чтобы все видели, что Вы работаете в данное время с заявкой, и другие пользователи не смогли ничего делать с заявкой кроме начальника отдела.
                                    <li><strong>Выполнить ее</strong> - значит заявку выполнили и через некоторое время она попадет в архив.</li>
                                    <li><strong>С заявкой ознакомился</strong> - если заявка поступает на отдел или на группу пользователей одного отдела, вам нужно нажать кнопку с заявкой ознакомился, в том случае если заявку уже взяли в работу. Иначе вы должны ее взять в работу.</li>
...
'HELP_edit_prof_text' => '<p>При необходимости вы можете внести изменения в свой профиль (поменять логин, адрес электронной почты, сменить язык и пароль). Так же вы можете управлять уведомлениями на сайте и Jabber.</p>',
'REFER_comment_add'=>'дополнил(а)',
...
'last_more'=>'еще',
'Shutdown'=> '<i class="fa fa-power-off"></i> Выключить сервер',
'Shut_title'=>'Выключение сервера',
'Shut_info'=>'В данном разделе при необходимости вы можете выключить сервер!',
'JS_shut'=> '<center><font size="18">Вы дейстивтельно хотите выключить сервер?</font></center>',
'JS_shut_cancel'=>'<i class="fa fa-remove"></i> Отменить выключение',
'Shut_show'=>'Серверу была послана каманда на выключение! Через несколько секунд он выключиться!',
'Shut_show_error'=>'Серверу не удалось выключиться, так как отсутствует пароль!',
'Shut_show_incorect_password'=>'Серверу не удалось выключиться, так как пароль неправильный!',
