...
<div class="panel panel-default">
<div class="panel-heading"><i class="fa fa-bell"></i> <?=lang('CONF_jabber_name');?></div>
<div class="panel-body">
  <form class="form-horizontal" role="form">
    <div class="form-group">
...
<center>
  ...
  <div class="col-md-12" id="conf_edit_jabber_res"></div>
  <div class="col-md-12" id="conf_test_jabber_res"></div>
</div>
</div>
