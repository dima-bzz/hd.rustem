...
if (validate_user($_SESSION['helpdesk_user_id'], $_SESSION['code'])) {
    ...
    <div class="container">
		    ...
		    <div class="col-md-3" style="padding-top:20px;">
                    <!-- <form action="<?=$CONF['hostname'];?>list" method="get"> -->
                        <div class="input-group">
                          <div id="input_er" data-toggle="popover" data-html="true" data-trigger="manual" data-container="body" data-placement="top" data-content="<?= lang('LIST_find_er'); ?>">
                          </div>
                          <div class="form-group" id="input_find_grp" style="display:inline;">
      ...
      <span class="input-group-btn">
        <button class="btn btn-default  btn-sm" type="button" title="Нажмите для поиска"
                id="b_find" ><?= lang('LIST_find_button'); ?></button>
      </span>
...
?>
            ...
            <input type="hidden" id="list_sort" value="<?= $_SESSION['hd.rustem_sort_in']; ?>">
