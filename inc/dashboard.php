...
<div class="col-md-12">
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading"><a href="statistics"><i class="fa fa-bar-chart-o"></i> <?= lang('DASHBOARD_ticket_stats'); ?></a></div>
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-4"><center>    <strong class="text-danger"  style="font-weight: bold; font-style: normal; font-variant: normal; font-size: 20px;" data-toggle="tooltip" data-placement="top" title="<?= lang('DASHBOARD_ticket_in_desc'); ?>">
                                    <a class="text-danger" href="#" value2="in" value="free" id="d_label_1"><?= get_total_tickets_free(); ?></a>
                                </strong><br><small><i class="fa fa-download"></i> <?= lang('DASHBOARD_ticket_in'); ?>	</small>	</center></div>

                        <div class="col-md-4 col-xs-4"><center>	<strong class="text-warning" style="font-weight: bold; font-style: normal; font-variant: normal; font-size: 20px;" data-toggle="tooltip" data-placement="top" title="<?= lang('DASHBOARD_ticket_lock_desc'); ?>"><a class="text-warning" href="#" value2="in" value="ilock" id="d_label_2"><?= get_total_tickets_lock(); ?></a></strong><br><small><i class='fa fa-lock'></i> <?= lang('DASHBOARD_ticket_lock'); ?> </small>	</center></div>

                        <div class="col-md-4 col-xs-4"><center>	<strong class="text-primary" style="font-weight: bold; font-style: normal; font-variant: normal; font-size: 20px;" data-toggle="tooltip" data-placement="top" title="<?= return_lang_out_label(); ?>"><a class="text-primary" href="list?out" id="d_label_3"><?= get_total_tickets_out_and_success_count(); ?></a></strong><br><small><i class="fa fa-upload"></i>  <?= lang('DASHBOARD_ticket_out'); ?></small>	</center></div>
	...
	<div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div id="last_news" style="max-height: 225px;
